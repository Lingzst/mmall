    ...
    0: function (t, e, r) {
        ...
        var s = r(1), n = r(9), i = {
            option: {
                ...
                var r = s.renderHtml(n, {navList: this.option.navList});
                $(".nav-side").html(r)
            }
        };
        t.exports = i
        ...
        "use strict";
        r(24), r(4), r(7), r(78);
        var s = (r(10), r(43)), n = r(1);
        $(function () {
            var t = n.renderHtml(s);
            $(".banner-con").html(t);
            var e = $(".banner").unslider({dots: !0});
        ...
        window.console && console.warn("This version of Unslider is due to be deprecated by December 1. Please visit unslider.com for details on how to upgrade."), function (t, e) {
            if (!t) return e;
            var r = function () {
                ...
                this.init = function (e, r) {
                    ...
                    var s = t(this), n = s.outerWidth(), i = s.outerHeight();
                    ...
                    var n = this.items.eq(e), i = {height: n.outerHeight()}, o = s ? 5 : this.opts.speed;
                    this.ul.is(":animated") || (r.el.find(".dot:eq(" + e + ")").addClass("active").siblings().removeClass("active"), this.el.animate(i, o) && this.ul.animate(t.extend({left: "-" + e + "00%"}, i), o, function () {
                    ...
                    var s = e.which, n = {37: r.prev, 39: r.next, 27: r.stop};
