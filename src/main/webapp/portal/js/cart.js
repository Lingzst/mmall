    ...
    0: function (t, e, r) {
        ...
        var c = r(1), s = {
            login: function (t, e, r) {
                c.request({url: c.getServerUrl("/user/login.do"), data: t, method: "POST", success: e, error: r})
                ...
                c.request({url: c.getServerUrl("/user/register.do"), data: t, method: "POST", success: e, error: r})
            }, checkLogin: function (t, e) {
                c.request({url: c.getServerUrl("/user/get_user_info.do"), method: "POST", success: t, error: e})
                ...
                c.request({url: c.getServerUrl("/user/get_information.do"), method: "POST", success: t, error: e})
                ...
                c.request({url: c.getServerUrl("/user/logout.do"), method: "POST", success: t, error: e})
            }
        };
        t.exports = s
    }, 3: function (t, e, r) {
        ...
        var c = r(1), s = {
            getCartCount: function (t, e) {
                c.request({url: c.getServerUrl("/cart/get_cart_product_count.do"), success: t, error: e})
            }, addToCart: function (t, e, r) {
                c.request({url: c.getServerUrl("/cart/add.do"), data: t, success: e, error: r})
            }, getCartList: function (t, e) {
                c.request({url: c.getServerUrl("/cart/list.do"), success: t, error: e})
            }, selectProduct: function (t, e, r) {
                c.request({url: c.getServerUrl("/cart/select.do"), data: {productId: t}, success: e, error: r})
            }, unselectProduct: function (t, e, r) {
                c.request({url: c.getServerUrl("/cart/un_select.do"), data: {productId: t}, success: e, error: r})
            }, selectAllProduct: function (t, e) {
                c.request({url: c.getServerUrl("/cart/select_all.do"), success: t, error: e})
            }, unselectAllProduct: function (t, e) {
                c.request({url: c.getServerUrl("/cart/un_select_all.do"), success: t, error: e})
            }, updateProduct: function (t, e, r) {
                c.request({url: c.getServerUrl("/cart/update.do"), data: t, success: e, error: r})
            }, deleteProduct: function (t, e, r) {
                c.request({url: c.getServerUrl("/cart/delete_product.do"), data: {productIds: t}, success: e, error: r})
            }
        };
        t.exports = s
    }, 4: function (t, e, r) {
        ...
        "use strict";
        r(20), r(7);
        var c = r(4), s = r(1), n = r(3), o = r(41), a = {
            data: {}, init: function () {
                this.onLoad(), this.bindEvent()
            }, onLoad: function () {
                this.loadCart()
                ...
                $(document).on("click", ".cart-select", function () {
                    var e = $(this), r = e.parents(".cart-table").data("product-id");
                    ...
                    var e = $(this), r = e.siblings(".count-input"), c = parseInt(r.val()),
                        o = e.hasClass("plus") ? "plus" : "minus", a = e.parents(".cart-table").data("product-id"),
                        l = 1, u = parseInt(r.data("max")), i = 0;
                    if ("plus" === o) {
                    ...
                    n.updateProduct({productId: a, count: i}, function (e) {
                        t.renderCart(e)
                    }, function (e) {
                        t.showCartError()
                    })
                    ...
                    if (window.confirm("确认要删除选中的商品？")) {
                        ...
                        e.length ? t.deleteCartProduct(e.join(",")) : s.errorTips("您还没有选中要的商品！")
                    }
                }), $(document).on("click", ".btn-submit", function () {
                    t.data.cartInfo && t.data.cartInfo.cartTotalPrice > 0 ? window.location.href = "./order-confirm.html" : s.errorTips("请选择商品后再提交")
                })
            }, loadCart: function () {
                var t = this;
